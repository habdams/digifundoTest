...
describe('Applicant Access Component Test', () => {
    ...
    it("should render an introductory message to the user",()=>{
        render(<ApplicantAccess />);
        const introText = screen.getByText(/Bitte geben Sie den an Ihre E-Mail/i);
        expect(introText).toHaveTextContent('Bitte geben Sie den an Ihre E-Mail gesendeten Zugangscode in das Feld unten ein.')
    })
